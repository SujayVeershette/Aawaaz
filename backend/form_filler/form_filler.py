...
SCHEME_FORMS = {
    "pm_kisan": {
        ...
        "fields": [
            ...
            {"selector": "#ContentPlaceHolder1_txtfarmername",  "profile_key": "name",         "label": "Farmer Name"},
            {"selector": "#ContentPlaceHolder1_ddlfarmercategory", "profile_key": "caste_category", "label": "Category", "type": "select"},
            {"selector": "#ContentPlaceHolder1_txtmobileno",    "profile_key": "mobile",       "label": "Mobile Number"},
            {"selector": "#ContentPlaceHolder1_txtaccno",       "profile_key": "bank_account", "label": "Account Number"},
            {"selector": "#ContentPlaceHolder1_ddlbankname",    "profile_key": "bank_name",    "label": "Bank Name", "type": "select"},
            {"selector": "#ContentPlaceHolder1_txtifsccode",    "profile_key": "ifsc",         "label": "IFSC Code"},
            {"selector": "#ContentPlaceHolder1_txtaddress1",    "profile_key": "village",      "label": "Village / Address"},
            {"selector": "#ContentPlaceHolder1_txtdistrict",    "profile_key": "district",     "label": "District"},
        ],
        "aadhar_field": "#ContentPlaceHolder1_txtadharno",
        "aadhar_submit": "#ContentPlaceHolder1_btnsubmit",
        "otp_trigger": "#ContentPlaceHolder1_btnsendotp",
